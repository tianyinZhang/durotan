...
public class ActivityTest {
    ...
    public void test_alterState() {
        log.info("提交审核，测试：{}", JSON.toJSONString(stateHandler.arraignment(120981321L, Constants.ActivityState.EDIT)));
